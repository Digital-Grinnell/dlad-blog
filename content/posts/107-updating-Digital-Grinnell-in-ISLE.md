...
lastmod: 2021-06-22T15:25:22-05:00
draft: false
tags:
  - ISLE
  - update
...
{{% annotation %}}
Attention: This is an annotated copy of the [ISLE project's](https://github.com/Islandora-Collaboration-Group/ISLE) [update.md](https://github.com/Digital-Grinnell/dg-isle/blob/main/docs/update/update.md) document. Annotations specifc to _Digital.Grinnell_ appear in specially formatted blocks like this one.
{{% /annotation %}}
