...
```
  - Annotations like this one always appear in a `code` block and bulleted list as you see here.   
  - This is an annotated copy of `install-local-migrate.md` from the `main` branch of `https://github.com/Islandora-Collaboration-Group/ISLE`.  
  - Copied on 22-Jun-2022  
  - The annotations here relate to the creation of a new `local` copy of Digital.Grinnell established on MacBook Pro asset tag `10713`  
  - Sub-sections pertinent to Windows are unnecessary and have been removed from this copy
```
...
* You will be using ISLE version **1.2.0** or higher.  `1.5.19`

* You are using Docker-compose **1.24.0** or higher.  `Confirmed`

* You have git installed on your personal computer.  `Confirmed`

* You have a previously existing private Islandora Drupal git repository.  `Confirmed`
...
* You have access to a private git repository in [Github](https://github.com), [Bitbucket](https://bitbucket.org/), [Gitlab](https://gitlab.com), etc.  
  ...
  - `https://github.com/Digital-Grinnell/dg-isle` and `https://github.com/Digital-Grinnell/dg-islandora` 
